...
import { AddCircleFilled, AppsFilled } from "@fluentui/react-icons"
import { Button, Input, InputIcon } from "keep-react"
import moment from "moment"
import { NavLink } from "react-router-dom"

import CategoryCardView from "./category-list-views/CategoryCardView"
import CategoryTableView from "./category-list-views/CategoryTableView"
          ...
          <div className="flex gap-4 font-bold">
            ...
            <div className="flex flex-col">
              <h1 className="text-afer-950 dark:text-afer-400 font-black text-4xl leading-none">
                {recentSearch === "" ? "Categorias" : recentSearch}
              </h1>
              {
                loading ? (
